            ...
            >
                ...
                {!submitted ? (
                    ...
                    <motion.div
                        ...
                        className="text-center bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-lg shadow-sm"
                    >
                        <div className="text-green-500 text-4xl sm:text-5xl mb-4 flex justify-center">
                            <FiMail />
                        </div>
                        <h3 className="text-lg sm:text-xl font-bold mb-2 dark:text-white">Check your email</h3>
                        <p className="text-gray-600 dark:text-gray-400 mb-6 text-sm sm:text-base">
                            We've sent a password reset link to your email address. The link will expire in 10 minutes.
                        </p>
                        <button
                            onClick={() => setSubmitted(false)}
                            className="text-primary-600 hover:text-primary-500 font-medium text-sm sm:text-base"
                        >
                ...
                <div className="text-center">
                    <Link to="/login" className="flex items-center justify-center text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-primary-600 transition-colors duration-200">
